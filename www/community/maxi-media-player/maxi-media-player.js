    ...
    return x`
      <div class="main" id="mediaControls">
        <div class="icons">
          ...
          <mxmp-shuffle hide=${noShuffle} .store=${this.store}></mxmp-shuffle>
          ...
          <mxmp-repeat hide=${noRepeat} .store=${this.store}></mxmp-repeat>
...
class Card extends i$4 {
  ...
  render() {
    ...
    return x`
      ...
      [
        QUEUE,
        () => x`<mxmp-queue .store=${this.store} @item-selected=${this.onMediaItemSelected}></mxmp-queue>`
      ]
...
class Grouping extends i$4 {
  ...
  groupingButton(icon, click) {
    return x` <mxmp-grouping-button @click=${click} .icon=${icon}></mxmp-grouping-button> `;
  }
  getNotJoinedPlayers() {
